...
export const TagLibrarySection: FC<TagLibrarySectionProps> = ({
  ...
  return (
    <section className="space-y-4">
      {/* Top Header */}
      <div className="bg-white rounded-xl border border-parchment-200 p-5 sm:p-6 shadow-paper">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 mb-4 border-b border-parchment-100">
          <div className="flex items-center gap-2">
            <Layers className="w-5 h-5 text-vermilion" />
            <h2 className="text-lg font-bold font-serif text-ink-900">
              步骤二：选择故事标签
            </h2>
            <span className="text-xs px-2 py-0.5 rounded-full font-mono bg-parchment-100 text-ink-600 border border-parchment-300">
          ...
          {onImportCustomMarkdown && (
            <label className="cursor-pointer inline-flex items-center gap-1.5 text-xs text-ink-600 hover:text-ink-900 px-3 py-1.5 rounded-lg border border-parchment-300 hover:bg-parchment-50 transition-colors">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 rounded-lg border border-parchment-300 bg-parchment-50/60 text-xs sm:text-sm text-ink-900 placeholder:text-ink-400 focus:outline-none focus:ring-2 focus:ring-vermilion/20 focus:border-vermilion transition-all"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md text-xs font-medium text-ink-700 bg-parchment-100 hover:bg-parchment-200 border border-parchment-300 transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md text-xs font-medium text-ink-600 hover:text-red-600 hover:bg-red-50 border border-parchment-300 transition-colors"
            >
      ...
      {/* Category Accordions */}
      {categories.length === 0 ? (
        <div className="p-8 text-center bg-white rounded-xl border border-parchment-200 shadow-paper text-ink-500">
